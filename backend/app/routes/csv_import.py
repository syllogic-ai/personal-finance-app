...
def get_import_history(
    ...
    rows = (
        db.query(CsvImport, Account.name.label("account_name"), txn_count_subq.c.txn_count)
        .outerjoin(Account, Account.id == CsvImport.account_id)
        .outerjoin(txn_count_subq, txn_count_subq.c.import_id == CsvImport.id)
    ...
    return [
        ...
        for imp, account_name, txn_count in rows
    ]
